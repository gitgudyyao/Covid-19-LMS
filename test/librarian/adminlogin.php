    ...
    <div class="page-body animated slideInDown">
        ...
        <div class="box">
            ...
            <div id="alertz" class="alert alert-warning collapse">
                <strong>Pending !</strong> Student Not Active!
            </div>
            <!--SIGN IN FORM-->
...
if (isset($_POST['Submit'])){
    ...
    if (count($signin_errors) == 0){
        $query1 = "SELECT * FROM librarian WHERE Email = '$email' OR Username = '$email'";
        ...
        $query2 = "SELECT librarian.Password FROM librarian WHERE Email = '$useremail' OR Username = '$username' ";
